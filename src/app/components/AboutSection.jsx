...
const TAB_DATA = [
    ...
    },
    {
        ...
        content: (
            <ul className="list-disc pl-2">
                <li>Undergraduate of Bachelor of Science in Computer Science</li>
    ...
    return (
        <section className="text-white" id="about">
         <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
            <Image src="/images/sithika.jpeg" width={500} height={500} />
            <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                ...
                <p className="text-base lg:text-lg">
                    ...
                    My journey in web development has been fueled by a love for coding and a desire to build user-friendly interfaces.
                </p>
